              ...
              <div className="flex flex-1 flex-col justify-between">
                <div className="flex items-start justify-between gap-2">
                  <Link
                    ...
                    className="font-display text-sm font-semibold text-charcoal hover:text-pink-600 sm:text-base"
                  >
                    {item.name}
                  </Link>
                  <button
                    onClick={() => removeItem(item.productId)}
                    className="text-charcoal-600/50 transition-colors hover:text-red-600"
        ...
        <div className="card h-fit p-6">
          ...
          <div className="mt-4 space-y-2 text-sm">
            ...
            <p className="text-xs text-charcoal-600">
              Delivery fee &amp; discounts calculated at checkout.
            </p>
          </div>
