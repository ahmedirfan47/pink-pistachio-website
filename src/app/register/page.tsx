    ...
    <div className="container-px mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center py-12">
      <div className="w-full card p-8">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-charcoal-600">Join Pink Pistachio for faster checkout &amp; order tracking.</p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input {...register('name')} className="input-field pl-11" placeholder="Your name" />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input {...register('phone')} className="input-field pl-11" placeholder="03XX XXXXXXX" />
            </div>
        ...
        <p className="mt-6 text-center text-sm text-charcoal-600">
          ...
          <Link href="/login" className="font-semibold text-pink-600 hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
