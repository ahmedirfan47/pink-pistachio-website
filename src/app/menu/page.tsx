  ...
  return (
    <div className="container-px mx-auto max-w-7xl py-12">
      <div className="mb-10 text-center">
        ...
        <h1 className="section-heading">{activeCategory ? activeCategory.name : 'Everything Pink Pistachio'}</h1>
      ...
      {/* Search */}
      <form action="/menu" className="mx-auto mb-8 max-w-md">
      ...
      <div className="mb-10 flex flex-wrap justify-center gap-2">
        <Link
          ...
          className={cn(
            ...
            !category ? 'bg-pink-600 text-white' : 'bg-pink-50 text-charcoal hover:bg-pink-100'
          )}
        >
          All Items
        </Link>
        {categories.map((c) => (
          <Link
            ...
            className={cn(
              'rounded-full px-4 py-2 text-sm font-medium transition-colors',
              category === c.slug ? 'bg-pink-600 text-white' : 'bg-pink-50 text-charcoal hover:bg-pink-100'
            )}
          >
            {c.name}
          </Link>
